# 제주대학교 중앙도서관 추천DVD 아카이브 운영 매뉴얼

이 저장소는 제주대학교 중앙도서관 추천DVD 콘텐츠를 격월 단위로 누적 관리하기 위한 GitHub Pages 저장소입니다.
...
```text
https://libjeju.github.io/dvds/
```

### 2026년 4번째 추천DVD 회차 홈

```text
https://libjeju.github.io/dvds/issues/2026-04/
```

### 뉴스레터

```text
https://libjeju.github.io/dvds/issues/2026-04/newsletter/2026-07-08/
```

### 카드뉴스

```text
https://libjeju.github.io/dvds/issues/2026-04/cardnews/2026-07-08/
```

### 이메일 발송용 페이지

```text
https://libjeju.github.io/dvds/issues/2026-04/email/2026-07-08/
```

### 포스터 자료 페이지

```text
https://libjeju.github.io/dvds/issues/2026-04/posters/
```
...
이 저장소는 추천DVD 콘텐츠를 장기적으로 누적 관리하기 위한 공간입니다.
...
2026년 4번째 추천DVD 자료가 들어 있는 회차 폴더입니다.
...
DVD 표지, 이미지, CSS, 기타 웹 자원이 들어가는 폴더입니다.
...
```html
<a href="./issues/2026-05/">2026년 5번째 추천DVD 보기</a>
```
...
```text
https://libjeju.github.io/dvds/issues/2026-05/
```
...
```text
https://libjeju.github.io/dvds/issues/2026-05/newsletter/2026-09-10/
https://libjeju.github.io/dvds/issues/2026-05/cardnews/2026-09-10/
```
...
```text
https://libjeju.github.io/dvds/issues/2026-04/posters/web/poster-web.jpg
```
...
```text
https://libjeju.github.io/dvds/issues/2026-04/posters/print/poster-a4.pdf
```
...
2026년 4번째 추천DVD는 다음 항목이 정상 작동하면 운영 준비가 완료된 것입니다.

```text
□ 전체 아카이브 홈 접속 가능
□ 2026년 4번째 추천DVD 회차 홈 접속 가능
□ 뉴스레터 페이지 접속 가능
□ 카드뉴스 페이지 접속 가능
□ 이메일 발송용 페이지 접속 가능
□ 포스터 자료 페이지 접속 가능
...
```text
1. https://libjeju.github.io/dvds/ 접속
2. 회차 홈 접속
3. 뉴스레터 접속
4. 카드뉴스 접속
5. 이메일 발송용 페이지 접속
...
이 저장소는 제주대학교 중앙도서관 추천DVD 콘텐츠를 장기적으로 축적하기 위한 공개 아카이브입니다.
